    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="微信openid" prop="openId">
          <el-input disabled v-model="form.openId" placeholder="微信openid" />
        </el-form-item>
        <el-form-item label="姓名" prop="name">
...
<script>
import { getSingerUser, getUser, delUser, addUser, updateUser, musiciansReview } from "@/api/system/userSettings";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getSingerUser(this.queryParams).then(response => {
